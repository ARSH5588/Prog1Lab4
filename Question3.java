...
*The user can have at maximum 10 trials. If the number is guessed, the user should be asked if *she/he wants to play again. If the number is not guessed and 10 trials were used, the user is *not lucky, the program should terminate with a proper message.
*/
